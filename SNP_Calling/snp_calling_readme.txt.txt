# Four main steps for using sentieon to call SNP and Indel by population using joint calling method
...
step3. [merge raw vcf, sort] split SNP and Indel
...
step4. Hard filter, do SNP and Indel, seperatly
VCF.final_filter.sh
[eg] sh VCF.final_filter.sh -g /dellfsqd2/P18Z19700N0073/zhangyaolei/project/killer_whale/01.genome/kw_ref.fa -v ./kw_151.snp.raw.vcf -p kw_151 -c SNP
[eg] sh VCF.final_filter.sh -g /dellfsqd2/P18Z19700N0073/zhangyaolei/project/killer_whale/01.genome/kw_ref.fa -v ./kw_151.indel.raw.vcf -p kw_151 -c INDEL
