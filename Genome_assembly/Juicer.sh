...
ln -s XX/04.nextpolish.genome/ref_genome.fa ./genome/ref_genome
...
XX/juicer_v3.sh -z genome/xquas098_genome -y genome/ref_genome_MboI.txt -p genome/ref_genome.size.txt -s MboI -d XX/06.Juicer -D /share/biosoft/pipeline/DNA/HiC_Assembly/04.Juicer -T 12 -S early -m 30G
